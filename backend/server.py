    ...
    try:
        ...
        for _, row in grouped.iterrows():
            ...
            if request.transit_session_id and request.transit_session_id in transit_data:
                ...
                # DEBUG: Print matching information (Enhanced)
                print(f"🔍 DEBUG ENHANCED - Looking for Article: '{row['article_code']}' at Depot: '{row['depot']}'")
                print(f"🔍 DEBUG ENHANCED - Available in transit data:")
                ...
                print(f"🔍 DEBUG ENHANCED - Matches found: {len(matching_transit)}")
                
                if not matching_transit.empty:
                    transit_available = float(matching_transit['Quantité'].sum())
                    print(f"✅ DEBUG ENHANCED - Transit available: {transit_available}")
                else:
                    print("❌ DEBUG ENHANCED - No matches found!")
