...
# Article codes extracted from Excel file column B (VENTES TEST.xlsx)
# Complete list of 122 article codes available in the system
AVAILABLE_ARTICLE_CODES = [
    '1011', '1012', '1021', '1022', '1028', '1032', '1033', '1040', '1047', '1059', 
    '1065', '1069', '1071', '1072', '1074', '1077', '1079', '1515', '1531', '1532', 
    '1533', '1537', '1540', '1559', '1566', '1569', '2011', '2014', '2022', '2032', 
    '2033', '2034', '2040', '2057', '2059', '2065', '2069', '3011', '3025', '3033', 
    '3040', '3043', '3049', '3059', '3060', '3068', '3069', '3071', '3073', '3120', 
    '3125', '3140', '3149', '3169', '3249', '3948', '3949', '3953', '4843', '4942', 
    '5018', '5029', '5030', '5037', '5038', '5059', '5118', '5130', '5138', '5159', 
    '5160', '5218', '5232', '5428', '5440', '5442', '5516', '5945', '6010', '6013', 
    '6016', '6020', '6025', '6028', '6030', '6038', '6040', '6051', '6059', '6066', 
    '6069', '6071', '6120', '6125', '6137', '6140', '6146', '6159', '6314', '6343', 
    '6514', '6543', '7316', '7342', '7346', '7360', '7426', '7532', '7610', '7616', 
    '7620', '7625', '7630', '7637', '7638', '7640', '7657', '7659', '7660', '7669', 
    '7725', '7999'
]

# Default depots for "configuration personnalisée" (custom configuration)
DEFAULT_CONFIGURATION_DEPOTS = [
...
async def chat_with_ai(request: ChatRequest):
    ...
    try:
        ...
        try:
            ...
            # ImportError or API error → fallback to minimal bullets
            print(f"Warning: Gemini API error, falling back to minimal response: {str(e)}")
            response_text = minimal_bullets(data_context)
